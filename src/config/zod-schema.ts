...
export const OpenClawSchema = z
  .object({
    ...
    update: z
      .object({
        channel: z
          .union([z.literal("stable"), z.literal("beta"), z.literal("dev"), z.literal("wooju")])
          .optional(),
    ...
    skills: z
      .object({
        ...
        entries: z
          ...
          .optional(),
        skipApiKeyPrompts: z.boolean().optional(),
      })
      .strict()
      .optional(),
    plugins: z
    ...
    template: z
      .object({
        type: z.union([z.literal("standard"), z.literal("wooju")]),
        role: z
          .union([
            z.literal("developer"),
            z.literal("planning"),
        ...
        stack: z
          .union([
            ...
            z.literal("android"),
            z.literal("frontend"),
            z.literal("backend-java"),
            z.literal("devops"),
          ])
          .optional(),
        service: z
          .union([z.literal("maps"), z.literal("shopping"), z.literal("search")])
          .optional(),
      })
      .strict()
      .optional(),
